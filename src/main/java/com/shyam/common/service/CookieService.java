...
/**
 * Utility service for cookie creation and manipulation.
 * Provides centralized cookie functionality to eliminate code duplication.
 */
public interface CookieService {
     ...
     */
    ResponseCookie createResponseCookie(String name, String value, boolean httpOnly,
                                        boolean secure, String sameSite, String path, int maxAge);
