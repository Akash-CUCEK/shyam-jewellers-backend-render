...
public class CookieServiceImp implements CookieService {
     ...
     */
    @Override
    public ResponseCookie createResponseCookie(String name, String value, boolean httpOnly,
        ...
        log.debug("Created ResponseCookie - Name: {}, Value: {}, HttpOnly: {}, Secure: {}, SameSite: {}, Path: {}, MaxAge: {}",
