...
public class PricingServiceImpl implements PricingService {
    ...
    public PriceBreakdownDTO calculatePrice(ProductVariant variant) {
        ...
        MetalRate metalRate = metalRateRepository.findLatestByMaterialType(materialType)
        ...
        if (fetchedAt != null) {
            ...
            if (duration.toHours() > 24) {
                log.warn("Metal rate for {} is stale (fetched at {}), consider updating",
                        materialType.getName(), fetchedAt);
            }
        }
