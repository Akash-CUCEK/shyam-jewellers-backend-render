...
public class ProductServiceImpl implements ProductService {
    ...
    public AddProductResponseDTO addProduct(AddProductRequestDTO requestDTO) {
        ...
        Category category = categoryRepository.findById(requestDTO.getCategoryId())
                .orElseThrow(() -> notFound("Category not found with id: " + requestDTO.getCategoryId()));

        MaterialType materialType = materialTypeRepository.findById(requestDTO.getMaterialTypeId())
                .orElseThrow(() -> notFound("Material type not found with id: " + requestDTO.getMaterialTypeId()));
    ...
    public AddProductResponseDTO updateProduct(UpdateProductRequestDTO requestDTO) {
        ...
        existing.setProductName(generateProductName(category, materialType, purity, existing.getProductId()));
    ...
    private String generateProductName(Category category, MaterialType materialType, Purity purity, Long productId) {
