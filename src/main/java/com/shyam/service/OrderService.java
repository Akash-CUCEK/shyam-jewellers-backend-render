...
public interface OrderService {
   ...
   */
  Order cancelOrder(Long orderId, String updatedBy);
  ...
  Order updateOrderStatus(Long orderId, String status, String updatedBy);
   ...
   *
   * <p>Contains the application order information and Razorpay order information.
   */
