...
public interface ProductVariantRepository
    ...
    @Transactional
    @Modifying
    @Query("UPDATE ProductVariant pv SET pv.reservedQuantity = pv.reservedQuantity + :quantity WHERE pv.variantId = :variantId AND (pv.quantity - pv.reservedQuantity) >= :quantity")
