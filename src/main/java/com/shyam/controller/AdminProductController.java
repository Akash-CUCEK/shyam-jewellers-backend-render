...
public class AdminProductController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Category/MaterialType/Purity not found", content = @Content),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content),
            @ApiResponse(responseCode = "403", description = "Forbidden - insufficient role", content = @Content),
            @ApiResponse(responseCode = "404", description = "Product/Category/MaterialType/Purity not found", content = @Content),
            @ApiResponse(responseCode = "500", description = "Internal server error", content = @Content)
    })
    ...
    @Operation(summary = "Delete product", description = "Soft-delete a product by setting status to INACTIVE.")
    @ApiResponses(value = {
    ...
    public BaseResponseDTO<AddProductResponseDTO> deleteProduct(
        ...
        DeleteProductRequestDTO requestDTO = DeleteProductRequestDTO.builder()
                .productId(productId)
                .updatedBy(updatedBy)
                .build();
    ...
    @Operation(summary = "Get all products (Admin view)", description = "Paginated list of all products, any status, filterable by category/material type/status.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get product by ID (Admin view)", description = "Get product details by ID, any status.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successful retrieval",
                    content = @Content(schema = @Schema(implementation = BaseResponseDTO.class))),
            @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content),
