...
public class AdminOrderController {
  ...
  @Operation(
      ...
      description =
          "Retrieve a paginated list of all orders with optional status and date filters.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  public BaseResponseDTO<Page<OrderResponseDTO>> getAllOrders(
    ...
    log.info(
        "Entering getAllOrders method with page: {}, size: {}, status: {}, startDate: {}, endDate: {}",
        page,
        size,
        status,
        startDate,
  ...
  @ApiResponses({
    ...
    @ApiResponse(
        responseCode = "400",
        description = "Invalid status or unable to update",
        content = @Content),
    @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content),
    @ApiResponse(
        responseCode = "403",
  ...
  public BaseResponseDTO<Order> updateOrderStatus(
      @PathVariable Long orderId, @RequestParam String status, @RequestParam String updatedBy) {
    log.info(
        "Entering updateOrderStatus method with orderId: {}, status: {}, updatedBy: {}",
        orderId,
        status,
        updatedBy);
    ...
    log.info("Exiting updateOrderStatus method");
    return new BaseResponseDTO<>(order, null);
  }
}
